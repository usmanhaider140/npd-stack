...
-- AddForeignKey
ALTER TABLE "UserSubscriptionPlan" ADD CONSTRAINT "UserSubscriptionPlan_planId_fkey" FOREIGN KEY ("planId") REFERENCES "SubscriptionPlan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
